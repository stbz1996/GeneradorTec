...
<?php
    ...
    $link_to_home = base_url()."/index.php/Administrator_controller";
    $link_to_edit = base_url()."/index.php/Administrator_controller/editPlan";
    $link_to_change = base_url()."/index.php/Administrator_controller/changeStatePlan";
    $link_to_add = base_url()."/index.php/Administrator_controller/addPlan";
    $link_to_delete = base_url()."/index.php/Administrator_controller/deletePlan";
    $link_to_courses = base_url()."/index.php/Administrator_controller/Courses";
?>
...
<head>
    ...
    <link rel="stylesheet" href="<?=base_url()?>css/Plan/plan.css" />
</head>
