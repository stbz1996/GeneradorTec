...
$(document).on('click', '.btn_add', function(){
	...
	$('#dynamic_field').append('<tr id="row'+count_activities+
		'"><td><input type="text" name="activityDescription[]" id="name" placeholder="Ingrese actividad" /></td><td><input type="number" name="workPorcent[]" min="0" value="0" class="textnum"></td><td><input type="button" name="remove" id="'+
